...
| Learn with a coaching strategy | Source-labelled practice feedback |
|---|---|
| ![Learn screen](docs/media/learn.png) | ![Practice feedback](docs/media/practice-feedback.png) |
| **Mock exam with delayed feedback** | **Phone layout** |
| ![Mock exam results](docs/media/mock-exam.png) | <img src="docs/media/mobile-overview.png" alt="Overview on a phone" width="260"> |
